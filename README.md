...
**Nova Client** is an Electron-based client for [Kirka.io](https://kirka.io), built with a focus on user-friendliness and easy experience with [KCH](https://kirkacommunityhub.netlify.app/) integration. (This client is **not a fork** of juice or any other client)

> ⚠️ **Project Status**:  
> This is a Opening of a Nova so there might be Changes 
